...
DESK_CSS = """
  ...
  .desk-locale-card:focus-visible { outline: 0; box-shadow: 0 0 0 3px rgba(93,96,238,0.35); }
  .desk-locale-name { margin: 0; font-size: var(--fs-lg); font-weight: 600; }
  ...
  /* Sticky footer -- unsaved decisions + queue */
  .desk-savebar {
