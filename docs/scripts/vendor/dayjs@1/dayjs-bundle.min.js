/*!
 * dayjs-bundle.min.js — dayjs@1 core + duration + utc plugins, pre-extended
 *
 * Replaces 3 separate <script src> tags in Webflow Site Settings → Custom Code → Inside <head>.
 * Combines (in order):
 *   1. vendor/dayjs@1/dayjs.min.js
 *   2. vendor/dayjs@1/plugin/duration.js
 *   3. vendor/dayjs@1/plugin/utc.js
 * + calls dayjs.extend(dayjs_plugin_duration) and dayjs.extend(dayjs_plugin_utc) so the
 * plugins are registered before any consumer runs.
 *
 * Rebuild (after a dayjs version bump):
 *   cd docs/scripts/vendor/dayjs@1 && \
 *     cat dayjs.min.js plugin/duration.js plugin/utc.js > dayjs-bundle.min.js && \
 *     printf '\ndayjs.extend(dayjs_plugin_duration);dayjs.extend(dayjs_plugin_utc);\n' \
 *     >> dayjs-bundle.min.js
 *
