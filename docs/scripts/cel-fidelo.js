 ...
 *
 * SKIN (Stage 2 — LIVE on /booking-new): a SEPARATE IIFE appended at the BOTTOM of this file
 * injects the CEL CSS skin (SKIN_CSS) into the widget, gated via document.referrer to the
 * /booking-new staging slug — the LIVE /booking page is never restyled. When the widget itself
...
(function () {
  ...
  function widgetIsArabic() {
    try {
      ...
      return l === 'ar' || /\/ar\/booking-new(?:[\/?#]|$)/.test(document.referrer || '');
    } catch (e) { return false; }
  }
